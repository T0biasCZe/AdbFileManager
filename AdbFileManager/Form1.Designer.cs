namespace AdbFileManager {
	partial class Form1 {
		...
		private void InitializeComponent() {
			...
			button_forward.FlatAppearance.MouseDownBackColor = SystemColors.Control;
			button_forward.FlatAppearance.MouseOverBackColor = SystemColors.Control;
			...
			button_back.FlatAppearance.MouseDownBackColor = SystemColors.Control;
			button_back.FlatAppearance.MouseOverBackColor = SystemColors.Control;
